...
public class UserService {
    ...
    public User join(UserDto userDto) {
        ...
        if (userRepository.findOneWithAuthoritiesByPhoneNumber(userDto.getPhoneNumber()).orElse(null) != null) {
    ...
    public ResponseEntity<TokenDto> login(LoginDto loginDto){
        ...
        redisTemplate.opsForValue()
                .set("RT:" + authentication.getName(), jwt.getRefreshToken(), jwt.getRefreshTokenExpirationTime(), TimeUnit.MILLISECONDS);
    ...
    public Optional<User> getMyUserWithAuthorities() {
        ...
        return SecurityUtil.getCurrentPhoneNumber().flatMap(userRepository::findOneWithAuthoritiesByPhoneNumber);
    }
